"""Hive 999 Marco-o1 creative-advisor adapter for JetBee backend."""
...
async def request_rhythm_advice(
    ...
    payload = {
        ...
        "specialist_prompt": {
            ...
            "instructions": "You are Hive 999, a rhythm-and-groove specialist. Provide structured creative advice only. Do not execute code or generate audio.",
        },
    }
    try:
